...
DADATA_URL = 'https://cleaner.dadata.ru/api/v1'
DADATA_TOKEN = config('DADATA_TOKEN')
DADATA_SECRET = config('DADATA_SECRET')
DADATA = Dadata(DADATA_TOKEN, DADATA_SECRET)

RETAIL_CRM = 'https://retailcrm22.retailcrm.ru'
RETAIL_CRM_KEY = config('RETAIL_CRM_KEY')
RETAIL_CRM_CLIENT = retailcrm.v5(RETAIL_CRM, RETAIL_CRM_KEY)
